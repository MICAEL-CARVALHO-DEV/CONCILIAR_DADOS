...
if (-not $SkipTest) {
  ...
  powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check_higiene_organizacao.ps1 -RepoRoot .
}

Write-Host "[hook] pronto. O pre-commit de higiene esta ativo." -ForegroundColor Green
